...
type TimeServiceClient interface {
	GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (*Response, error)
}
...
func (c *timeServiceClient) GetTime(ctx context.Context, in *GetTimeRequest, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/timePack.TimeService/GetTime", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeServiceServer interface {
	GetTime(context.Context, *GetTimeRequest) (*Response, error)
...
func (UnimplementedTimeServiceServer) GetTime(context.Context, *GetTimeRequest) (*Response, error) {
...
func _TimeService_GetTime_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/timePack.TimeService/GetTime",
	}
...
var TimeService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "timePack.TimeService",
